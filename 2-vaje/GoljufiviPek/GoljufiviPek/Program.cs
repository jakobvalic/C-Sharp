...
namespace GoljufiviPek
{
    class Program
    {
        ...
        private static void preberiPodatke()
        {
            ...
            goljufivost(steviloHlebcev, stevecNapacnih);
        }

        private static void goljufivost(int steviloHlebcev, int stevecNapacnih)
        {
            //računamo ali bo pek pil vodo
            if (stevecNapacnih > steviloHlebcev * 0.15) Console.WriteLine("Peka v vodo takoj!!!!");
